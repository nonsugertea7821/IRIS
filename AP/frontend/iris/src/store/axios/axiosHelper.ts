...
class AxiosHelper {
    ...
    private options: Required<Pick<AxiosHelperOptions, "baseURL" | "timeout" | "headers" | "refreshEndpoint" | "maxRetries" | "retryDelay" | "dedupe">> & {
     ...
     */
    public async request<T = any>(config: AxiosRequestConfig, opts?: { force?: boolean; retry?: number }): Promise<T> {
    ...
    public get<T = any>(url: string, config?: AxiosRequestConfig, opts?: { force?: boolean; retry?: number }): Promise<T> {
        return this.request<T>({ ...(config || {}), method: "get", url }, opts);
    }

    public post<T = any>(url: string, data?: any, config?: AxiosRequestConfig, opts?: { force?: boolean; retry?: number }): Promise<T> {
        return this.request<T>({ ...(config || {}), method: "post", url, data }, opts);
    }

    public put<T = any>(url: string, data?: any, config?: AxiosRequestConfig, opts?: { force?: boolean; retry?: number }): Promise<T> {
        return this.request<T>({ ...(config || {}), method: "put", url, data }, opts);
    }

    public delete<T = any>(url: string, config?: AxiosRequestConfig, opts?: { force?: boolean; retry?: number }): Promise<T> {
